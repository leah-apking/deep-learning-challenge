...
I then tried to combine these models by using both the ReLU and tanh activation functions with additional hidden layers. This resulted in the highest accuracy score acheived utilizing the full dataset of `0.7291` . Finally, tried eliminating what appeared to be extraneous features such as application type, status, special considerations, and affiliations. This improved the accuracy score slightly to `0.7334`, but still fell short of the 0.75 goal.

<img width="960" alt="Screen Shot 2023-05-25 at 11 37 26 AM" src="https://github.com/leah-apking/deep-learning-challenge/assets/119013360/964c8108-2d66-4b97-9313-754cbe1090f8">
<img width="680" alt="Screen Shot 2023-05-25 at 11 37 52 AM" src="https://github.com/leah-apking/deep-learning-challenge/assets/119013360/44acf488-5468-4414-92be-36c0ff25ff82">

## Summary: 
Using a neural network deep learning model produced a maximum accuracy score of `0.7291` when utilizing all the data provided, shy of the 0.75 goal. This was acheived by combining the ReLU and tanh activation functions and four hidden layers of neurons ranging from 15 to 6 neurons per layer. Even when utilizing the Teras Tuner to test a variety of different combinations, the difference in accuracy scores was less than 0.2 percent. Due to the limited effect of changing activation functions, additional hidden layers, and additional neurons in each layer as well as the network reaching its maximum accuracy with relatively few epochs, I believe a different method of machine learning may be a better fit for this dataset.
